...
export default function SideMenu() {
    ...
    return (
        <div className="absolute top-0">
            <button
                className="absolute top-5 left-5 z-[60] rounded-sm bg-transparent"
            ...
            <div className={`fixed top-10 w-[30vh] h-[calc(100vh-40px)] bg-primary-100 border border-secondary-200 border-2 transition-transform duration-300
